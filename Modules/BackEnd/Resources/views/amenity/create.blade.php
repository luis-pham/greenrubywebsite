...
@php
    ...
    $routeParams = ['lastUrl' => Request::get('lastUrl')];
    if ($languageCode) {
...
@section('content')
    ...
    {{ Form::open(['route' => [Utilities::getRouteName('backend.amenity.store'), $routeParams] ]) }}
        <div class="row">
            <div class="col-md-8">
                <div class="card mb-3">
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    <div class="card-header">
                        <h6 class="m-0"><i class="fas fa-image"></i> BIỂU TƯỢNG <span class="text-danger">*</span></h6>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            {{ Form::hidden('icon', old('icon'), ['class' => 'image-select', 'data-link-full' => Utilities::getFileLink(old('icon')), 'data-file-manager-url' => route('backend.file.index', ['layout' => 'popup', 'type' => config('backend.fileType.image')])]) }}
                        </div>
                    </div>
                </div>
                <div class="card mb-3">

...
@section('content')
    ...
    {{ Form::open(['route' => [Utilities::getRouteName('backend.category.store'), ['languageCode' => $languageCode, 'typeName' => $typeName, 'lastUrl' => Request::get('lastUrl')]], 'id' => 'frm']) }}
        <div class="row">
            <div class="col-lg-8">    
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-horizontal">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Nhập tênp...', 'maxlength' => 50, 'autocomplete' => 'off']) }}
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div class="select2">
                                        {{ Form::select('parent_id', $listParent, null, ['class' => 'form-control', 'placeholder' => 'Chọn', 'autocomplete' => 'off']) }}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    {{ Form::text('icon', null, ['class' => 'form-control', 'placeholder' => 'Nhập biểu tượng...', 'maxlength' => 50, 'autocomplete' => 'off']) }}
                                </div>
                            </div>
                            <div class="form-group row">

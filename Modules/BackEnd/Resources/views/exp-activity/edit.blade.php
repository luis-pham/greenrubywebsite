                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-0">
                            ...
                            {{ Form::text('seo_description', old('seo_description', $obj->seo_description), ['class' => 'form-control', 'placeholder' => 'Để trống = dùng mô tả ngắn', 'maxlength' => 255, 'autocomplete' => 'off']) }}
                        </div>
                    </div>
                </div>
                <div class="card mb-3">

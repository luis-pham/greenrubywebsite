...
@section('content')
    ...
    {{ Form::open(['route' => [Utilities::getRouteName('backend.faq.update'), ['languageCode' => $languageCode, 'id' => $obj->id, 'lastUrl' => Request::get('lastUrl')]], 'id' => 'frm']) }}
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-horizontal">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <div class="select2">
                                {{ Form::select('group_id', $listGroup, old('group_id', $obj->group_id), ['class' => 'form-control', 'placeholder' => 'Chọn', 'autocomplete' => 'off']) }}
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {{ Form::textarea('question', old('question', $obj->question), ['rows'=> 5, 'class' => 'form-control', 'placeholder' => 'Nhập câu hỏi...', 'autocomplete' => 'off']) }}
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label">Trả lời <span class="text-danger">*</span></label>
                        <div class="col-md-10">
                            {{ Form::textarea('answer', old('answer', $obj->answer), ['rows'=> 5, 'class' => 'form-control', 'placeholder' => 'Nhập trả lời...', 'autocomplete' => 'off']) }}
                        </div>
                    </div>
                </div>
            </div>

...
@section('content')
    ...
    {{ Form::open(['route' => [Utilities::getRouteName('backend.menuFrontEnd.store'), ['languageCode' => $languageCode, 'lastUrl' => Request::get('lastUrl')]], 'id' => 'frm']) }}
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {{ Form::text('code', null, ['class' => 'form-control', 'placeholder' => 'Nhập mã...', 'maxlength' => 50, 'autocomplete' => 'off']) }}
                        </div>
                    </div>
                    <div class="form-group row">

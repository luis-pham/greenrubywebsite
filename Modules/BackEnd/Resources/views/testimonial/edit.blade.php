...
@section('content')
    ...
    @php
        ...
        $updateRouteName = \Modules\BackEnd\Helpers\Utilities::getRouteName('backend.testimonial.update');
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            {{ Form::hidden('avatar', old('avatar', $obj->avatar), ['class' => 'image-select', 'data-link-full' => Utilities::getFileLink($obj->avatar), 'data-file-manager-url' => route('backend.file.index', ['layout' => 'popup', 'type' => config('backend.fileType.image')])]) }}
                        </div>
                    </div>
                </div>
                <div class="card mb-3">

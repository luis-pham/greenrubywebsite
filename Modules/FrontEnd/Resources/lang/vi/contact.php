...
return [
    ...
    'hero.eyebrow' => 'Liên Hệ',
    'hero.title_html' => 'Cùng Lên Kế Hoạch <em>Chuyến Đi Hoàn Hảo.</em>',
    'hero.description' => 'Đội ngũ sẵn sàng giúp bạn chọn hành trình, cabin và ngày khởi hành phù hợp với Green Ruby.',
    'left.eyebrow' => 'Liên Hệ Trực Tiếp',
    'left.title_html' => 'Chúng Tôi <em>Sẵn Sàng Hỗ Trợ.</em>',
    'left.tagline' => 'Hỏi về hành trình, phòng trống hoặc yêu cầu đặc biệt — liên hệ trực tiếp với chúng tôi.',
    'label.whatsapp' => 'Whatsapp',
    'label.email' => 'Email',
    'form.title' => 'Gửi Tin Nhắn',
    'form.sub' => 'Chúng tôi thường phản hồi trong vòng 2 giờ trong giờ làm việc.',
    'form.interest_label' => 'Tôi quan tâm đến',
    'form.interest_placeholder' => 'VD: 2N1Đ Vịnh Hạ Long, Opera Suite...',
    'form.submit' => 'Gửi Tin Nhắn →',
    'form.privacy_note' => 'Chúng tôi tôn trọng quyền riêng tư của bạn. Không spam.',
    'alert.success_title' => 'Thành công',
    'alert.error_title' => 'Lỗi',
    'alert.ok' => 'OK',
];

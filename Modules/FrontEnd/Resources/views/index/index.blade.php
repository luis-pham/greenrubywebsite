                                        ...
                                        <div class="eco-icon-wrap">
                                            @if ($i === 0)
                                                <svg width="56" height="56" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                    ...
                                                    <path d="M20 27C20 27 21.5 30 24 30C26.5 30 28 27 28 27" stroke="#0D2B1A" stroke-width="1.5" fill="none" stroke-linecap="round"/>
                                                    <line x1="24" y1="17" x2="24" y2="23" stroke="#0D2B1A" stroke-width="1" stroke-linecap="round" opacity="0.5"/>
                                                    <line x1="21" y1="20" x2="27" y2="20" stroke="#0D2B1A" stroke-width="1" stroke-linecap="round" opacity="0.5"/>
                                                </svg>
                                            @elseif ($i === 1)
                                                <svg width="56" height="56" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                    ...
                                                    <path d="M18 30C18 30 20.5 34 24 34C27.5 34 30 30 30 30" stroke="#0D2B1A" stroke-width="1.5" fill="none" stroke-linecap="round"/>
                                                </svg>
                                            @elseif ($i === 2)
                                                <svg width="56" height="56" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                    ...
                                                    <path d="M24 32L24 37M21 37L27 37" stroke="#0D2B1A" stroke-width="1.25" stroke-linecap="round"/>
                                                    <path d="M10 25L13 25M35 25L38 25" stroke="#0D2B1A" stroke-width="1.25" stroke-linecap="round" opacity="0.5"/>
                                                </svg>
                                            @else
                                                <svg width="56" height="56" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                                    ...
                                                    <path d="M14 22C14 22 16 14 24 13C32 12 35 18 35 18" stroke="#0D2B1A" stroke-width="1.25" fill="none" stroke-linecap="round" opacity="0.6"/>
                                                    <path d="M35 18L32 17M35 18L34 21" stroke="#0D2B1A" stroke-width="1.25" stroke-linecap="round" opacity="0.6"/>
                                                </svg>
                                            @endif
                                        </div>

    ...
    <div class="container-fluid position-relative">
                ...
                @if (array_key_exists('website-logo-negative', $config) && $config['website-logo-negative'])
                    ...
                    @if ($isHome) <h1 class="mb-0"> @endif
                        <a href="{{ route(Utilities::getRouteName('frontend.index'), ['languageCode' => $languageCode]) }}" class="d-block">
                            <img src="{{ Utilities::getFileLink($config['website-logo-negative']) }}" alt="{{ $config['website-name'] }}" class="img-fluid" width="117" height="93" />
                        </a>
                    @if ($isHome) </h1> @endif
                @endif
            </div>
        ...
        <div class="header-mobile d-flex d-md-none align-items-center justify-content-between position-relative text-white">
            <div class="header-left">
                @if (array_key_exists('website-logo-negative', $config) && $config['website-logo-negative'])
                    <a href="{{ route(Utilities::getRouteName('frontend.index'), ['languageCode' => $languageCode]) }}" class="d-block">
                        <img src="{{ FeUtils::getImageLink($config['website-logo-negative']) }}" alt="{{ $config['website-name'] }}" class="img-fluid" width="117" height="93" />
                    </a>
                @endif
            </div>

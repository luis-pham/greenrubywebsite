            ...
            @if (count($list) > 0)
                ...
                <div class="d-none d-lg-block">
                    ...
                    @if ($showButtonViewAll)
                        <div class="btn-view-all-wrapper text-center">
                            <a href="javascript:;" class="btn-view-all btn-ghost-gold">
                                {{ __('frontend::common.button_view_all') }}
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 12l14 0"/><path d="M15 16l4 -4"/><path d="M15 8l4 4"/></svg>
                            </a>
                        </div>
                    @endif
                </div>
                <div class="d-block d-lg-none">
                    <div class="slide-1">
                        ...
                        @if ($showButtonViewAll)
                            <div class="btn-view-all-wrapper text-center">
                                <a href="javascript:;" class="btn-view-all-mobile btn-ghost-gold">
                                    {{ __('frontend::common.button_view_all') }}
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 12l14 0"/><path d="M15 16l4 -4"/><path d="M15 8l4 4"/></svg>
                                </a>
                            </div>
